<form action="{{ route($tarantula->url(), $tarantula->id) }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="" name="common_name" value="{{ $tarantula->common_name }}" placeholder="Rodillas rojas, Chilena rosada...">
  </div>

  <div class="form-group">
    <label>Nombre Científico</label>
    <input type="text" class="form-control" id="" name="scientific_name" value="{{ $tarantula->scientific_name }}" placeholder="Brachypelma Vaganas, auratum...">
  </div>

  <div class="form-group">
    <label>Tamaño</label>
    <input type="text" class="form-control" id="" name="size" value="{{ $tarantula->size }}" placeholder="especificar en cm">
  </div>

  <div class="form-group">
    <label>Precio</label>
    <input type="text" class="form-control" id="" name="price" value="{{ $tarantula->price }}" placeholder="MXN">
  </div>
